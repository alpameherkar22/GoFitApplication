...
class Pro19 : AppCompatActivity() {
    lateinit var backbtn: Button
    lateinit var  contact: Button
    var buy: TextView?=null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_pro19)
        backbtn = findViewById(R.id.back)
        backbtn.setOnClickListener {

            val startAct = Intent(this@Pro19, Buypro::class.java)
        ...
        contact.setOnClickListener {
            ...
            val startAct = Intent(this@Pro19, Contact::class.java)
            startActivity(startAct)
            this.finish()

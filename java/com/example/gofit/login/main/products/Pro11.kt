...
class Pro11 : AppCompatActivity() {
    lateinit var backbtn: Button
    lateinit var  contact: Button
    var buy: TextView?=null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_pro11)
        backbtn = findViewById(R.id.back)
        backbtn.setOnClickListener {

            val startAct = Intent(this@Pro11, Buypro::class.java)
        ...
        contact.setOnClickListener {
            ...
            val startAct = Intent(this@Pro11, Contact::class.java)
            startActivity(startAct)
            this.finish()
